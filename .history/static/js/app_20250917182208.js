class RenderFlow {
        ...
        loadPreviewImage(jobId, imageUrl) {
          ...
          if (imageUrl.startsWith('file://')) {
            // Show clickable link for local files
            previewElement.innerHTML = `
              <div class="file-preview">
                <div class="file-icon">📁</div>
                <a href="${imageUrl}" target="_blank" class="file-link">
                  Open Local Image
                </a>
                <div class="file-path">${imageUrl}</div>
              </div>
            `;
          } else {
            // Regular image loading for http/https URLs
            const img = new Image();
            img.onload = () => {
