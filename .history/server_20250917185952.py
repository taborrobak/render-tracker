...
async def get_job_preview(job_id: int, base_dir: Optional[str] = Query(default="file:///home/tabor/render_tracker/renders/")):
    ...
    # Generate file:// URL using the provided base directory
    # Ensure base_dir ends with /
    if not base_dir.endswith('/'):
        base_dir += '/'
    
    file_url = f"{base_dir}{job_id}.png"
